  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <Planet
        ...
        colors={["rgba(168,85,247,0.4)", "rgba(34,211,238,0.4)", "rgba(236,72,153,0.4)"]}
        ringSpeeds={[28, 20, 24]}
        floatDuration={10}
      />
      ...
      <Planet
        ...
        colors={["rgba(34,211,238,0.4)", "rgba(52,211,153,0.4)", "rgba(168,85,247,0.4)"]}
        ringSpeeds={[22, 16, 18]}
        floatDuration={8}
      />
      ...
      <Planet
        ...
        colors={["rgba(236,72,153,0.4)", "rgba(168,85,247,0.4)", "rgba(34,211,238,0.4)"]}
        ringSpeeds={[18, 12, 15]}
        floatDuration={6}
      />
      ...
      <Planet
        ...
        colors={["rgba(52,211,153,0.5)", "rgba(34,211,238,0.5)", "rgba(168,85,247,0.5)"]}
        ringSpeeds={[14, 10, 12]}
        floatDuration={5}
      />
    </div>
