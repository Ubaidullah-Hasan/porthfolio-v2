  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center gap-3">
        <div className={`rounded-lg bg-linear-to-br ${category.color} p-2.5 text-black`}>
          <Icon className="h-5 w-5" />
        </div>
        <h3 className={`text-xl font-semibold bg-linear-to-r ${category.color} bg-clip-text text-transparent`}>
          {category.title}
        </h3>
      </div>
